...
const TEMP_RATING_COUNT = 27;
const TEMP_RATING_DISTRIBUTION: Record<number, number> = {
    5: 60,
    4: 25,
    3: 10,
    2: 3,
        ...
        <div className="px-4 lg:px-12 py-10">
            <div className="border rounded-sm bg-white overflow-hidden">
                <div className="relative aspect-[3.9] border-b">
                    <Image src={data.image?.url || "/auth-bg.png"}
                           alt={data.name}
                    ...
                    <div className="lg:col-span-2 border-t lg:border-t-0 lg:border-l">
                        <div className="flex flex-col gap-4 p-6 border-b">
                            ...
                            <p className="text-center font-medium">
                                {
                                    data.refundPolicy === "no-refunds" ? "No refunds" : `${data.refundPolicy}`
                                }
                            </p>
                        </div>
                        ...
                        <div className="p-6">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-x-1 font-medium">
                                    ...
                                    <p>({TEMP_RATING_SUMMARY})</p>
                                    <p className="text-base">{TEMP_RATING_COUNT} ratings</p>
                                </div>
                            </div>
                            <div className="grid grid-cols-[auto_1fr_auto] gap-3 mt-4">
                                {[5, 4, 3, 2, 1].map((stars) => (
                                    <Fragment key={stars}>
                                        ...
                                        <Progress
                                            value={TEMP_RATING_DISTRIBUTION[stars]}
                                            className="h-[1lh]"
                                        />
                                        <div className="font-medium">
                                            {TEMP_RATING_DISTRIBUTION[stars]}%
                                        </div>
                                    </Fragment>
                                ))}
                            </div>
